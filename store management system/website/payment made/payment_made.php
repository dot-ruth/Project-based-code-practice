...
<div class="sidenav">
    ...
    <table border="2" width="100%">
        <th colspan="4" style="text-align: center;">All Payments Made 
        <a href="pay_made.php"><input id="pay_made" type="submit" value="Add  Payment Made Detail" name="addpay_made" 
       ...
       " ></a>
        ...
        <tbody id="tb">
                ...
                $result =   mysqli_query($connect,"SELECT * FROM pay_made ");
