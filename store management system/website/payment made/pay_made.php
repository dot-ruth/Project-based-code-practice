...
if(isset($_POST["addbtn"])){
    ...
    $query="INSERT INTO pay_made values('$date','$payment','$reference','$amount')";
...
?>
           ...
           <a href="payment_made.php"><button type="button" class="submitBtn"id="backtoorder" style="margin:10px;">Go Back </button></a>
