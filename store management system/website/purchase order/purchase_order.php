...
<div class="sidenav">
    ...
    <table border="2" width="100%">
        ...
        <a href="purchaseorder.php"><input id="purchase" type="submit" value="Add  Purchase Order Detail" name="addpurchaseorder" 
       ...
       " ></a>
        ...
        <tbody id="tb">
                ...
                $result =   mysqli_query($connect,"SELECT * FROM purchase_order ");
                if($result->num_rows>0){
                    ...
                    <tr>
                        ...
                        <td><?php echo $val["purchase_order#"]; ?></td>

                        <td><?php echo $val["reference#"]; ?></td>

                        <td><?php echo $val["status"]; ?></td>

                        <td><?php echo $val["recieved"]; ?></td>

                        <td><?php echo $val["billed"]; ?></td>
