...
if(isset($_POST["addbtn"])){
    ...
    $query="INSERT INTO pay_rev values('$date','$payment','$CN','$amount')";
...
<head>
    ...
    <title>Add Recieved Payment</title>
...
<form action="" id="additemsform" class="form" method="post" >
					  <h1 class="title">Add Recieved Payment Details</h1>
					  ...
					  <div class="inputContainer">
						<label for="" class="label">Payment#</label>
...
?>
           ...
           <a href="payment_rev.php"><button type="button" class="submitBtn"id="backtoorder" style="margin:10px;">Go Back </button></a>
